...
<body>
<img src="/AdminDashboard/chatbot/download.png" alt="Chat Bot" id="chatbot-button" style="position: fixed; bottom: 20px; right: 20px; width: 50px; height: 50px; border-radius: 50%; cursor: pointer;">
